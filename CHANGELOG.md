...
- **The native novel reader now runs straight on into the next chapter, with no load screen at the boundary.** Scrolling back into the one before works the same way, the title and progress follow the chapter you are actually in, and Settings -> Novel reader -> Continuous chapters turns it off.
